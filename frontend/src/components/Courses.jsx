...
const Courses = () => {
  ...
  const handleLogout = async () => {
    try {
      ...
      toast.error(error.response.data.errors || "Errors in logged out!");
    }
  };
  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-screen bg-gray-100 w-64 p-5 transform z-10
      ...
      <main className="ml-0 w-full bg-white p-4 md:p-10">
        <header className="flex flex-col md:flex-row justify-between items-center mb-10">
          <h1 className="text-xl font-bold mb-4 md:mb-0">Courses</h1>
